...
local Profiler = prototype(function(self)
   self.time_at_last_report = 0
...
function Profiler:tick()
   ...
   if current_time - self.time_at_last_report > self.report_interval then
      print(profile.report("time", 20))
      profile.reset()
